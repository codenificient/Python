...
def calculate_error(m, b, point):
  x_point = point[0]
  y_point = point[1]
  dist_x = get_y(m, b, x_point)
  return abs(dist_x - y_point)
...
# Tasks 8 and 9
possible_ms = [i*0.1 for i in range(-100, 101) ] # '''your list comprehension here'''
possible_bs = [i*0.1 for i in range(-200, 201)] # '''your list comprehension here'''
# print(possible_ms)
# print(possible_bs)
# Task 10
